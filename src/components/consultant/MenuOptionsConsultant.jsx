            ...
            <div className="options-m options-m-dataUser" onClick={() => setEnabledMyData(!enabledMydata)}>
                ...
                {enabledMydata && (
                    <ul className="ul-options-myData">
                        <Link to={`/consultor/dados-do-perfil`} className="ul-options-myData-li li-mydata" onClick={onClick}>Dados do perfil</Link>
                        <Link to={`/consultor/especialidades`} className="ul-options-myData-li li-scheduleAppoiment" onClick={onClick}>Minhas specialidades</Link>
                        <Link to={`/consultor/agenda`} className="ul-options-myData-li li-scheduleAppoiment" onClick={onClick}>Agenda</Link>
